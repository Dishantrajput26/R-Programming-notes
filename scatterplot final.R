...
#define how much one variable is affected by other variable
...
#__________________________________________________________
#We can compare two scatter plot consecutively, 
...
plot(x1,y1,main="Result",xlab="X-label",
     ylab="y-label",col="red",cex=2)


points(x2,y2,col="blue",cex=2)
#_____________________________________________________________
data<-mtcars[,c('wt','mpg')] 
png(file="scatterplot.jpg") #Exporting graphics to a PNG file
plot(x=data$wt,y=data$mpg,xlab="Weight",ylab="Mil",
     xlim=c(2.5,5),ylim=c(15,30),main="weight v/sMil")
dev.off()  # to close plotting device

# go to documents, and check 