...
#**********************************************************
#while loop
#while loop is used when you dont know the exact number of times the loop 
#is repeated
#1 find the sum of 10 natural numbers starting from n
...
print(sum)
#****************************************************
#2 Program to initialize charcter vector of len 2 and 
#print the vec 6 times using while loop
...
#4********************************************************
# Print 10 numbers starting from 1 using break statement when number reaches 6
n<-1
while(n<=10){
  print(n)
  n=n+1
...
# starting from 1, print even odd from first 10 natural numbers
...
#while loop to print odd number between 1 to 10 using next
number=1
while(number<=10){
  if(number%%2==0){
    number=number+1
